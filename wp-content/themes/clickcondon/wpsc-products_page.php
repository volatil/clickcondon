				...
				<a class="wpsc_product_title" href="<?php echo esc_url( wpsc_the_product_permalink() ); ?>">
					...
					<div class="productcol" style="margin-left:<?php echo $image_width + 20; ?>px;" >
						...
						<div class="additional_description_container">
								<img class="additional_description_button"  src="<?php echo WPSC_CORE_THEME_URL; ?>wpsc-images/icon_window_expand.gif" alt="<?php esc_html_e( 'Additional Description', 'wp-e-commerce' ); ?>" />
								<?php esc_html_e('More Details', 'wp-e-commerce'); ?>
